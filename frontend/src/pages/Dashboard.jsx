...
import { fmtTime, fmtShortDate } from '../utils/dateUtils';
...
return ( <div> <div className="topbar"> <span className="topbar-title">Dashboard</span> <div className="topbar-actions">
<span style={{ fontSize: 13, color: 'var(--gray-500)' }}>
Welcome back, <strong>Sambhav</strong> </span> </div> </div>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
      ...
      <div className="card">
        ...
        <div style={{ padding: '8px 0' }}>
          {upcoming.length === 0 ? (
            <p style={{ padding: '16px 24px', fontSize: 14, color: 'var(--gray-400)' }}>
